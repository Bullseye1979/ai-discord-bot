...
const tools = [
  ...
  },
  {
    ...
    function: {
      name: "getLocation",
      description:
        "Handle location tasks: route between locations or place pins without a route. Returns map URL, street-view URL, URL of a static streetview image and text description. Always show all links in the answer.",
      parameters: {
        type: "object",
        properties: {
          locations: {
